...
window.addEventListener('scroll', function(){
    ...
    clouds1.style.top = -value * 0.1 + 'px';
    clouds2.style.top = -value * 0.1 + 'px';
    ground1.style.top = -value * 0.2 + 'px';
    ground2.style.top = -value * 0.3 + 'px';
    ground3.style.top = -value * 0.3 + 'px';
